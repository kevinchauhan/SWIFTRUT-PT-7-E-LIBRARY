    ...
    useEffect(() => {
        const fetchBook = async () => {
            try {
                ...
                const { title, author, genre, description, availableCopies, image } = book;
                setTitle(title);
                setAuthor(author);
                setGenre(genre);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                navigate('/my-issued-books'); // Redirect after update
            }
        } catch (error) {
    ...
    return (
        <div className="flex justify-center items-center min-h-screen">
            <div className="w-full max-w-4xl p-8 bg-white shadow-xl rounded-lg">
                <h2 className="text-3xl font-semibold text-center text-gray-800 mb-6">Edit Book</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            {availableCopiesError && (
                                <p className="text-red-500 text-sm mt-1">{availableCopiesError}</p>
                            )}
                        </div>
                    </div>
